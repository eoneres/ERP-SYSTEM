#!/bin/bash
# =============================================================================
# SEED DO BANCO DE DADOS — ERP System
# Cria: tenant demo + usuário admin + categorias financeiras padrão
...
# =============================================================================
# Cria o arquivo de seed TypeScript
# =============================================================================
...
echo "✅ src/infrastructure/database/seed.ts criado"

# =============================================================================
# Adiciona script no package.json do backend
# =============================================================================
node -e "
const fs = require('fs');
const pkg = JSON.parse(fs.readFileSync('package.json', 'utf8'));
pkg.scripts = pkg.scripts || {};
pkg.scripts['db:seed'] = 'ts-node -r tsconfig-paths/register src/infrastructure/database/seed.ts';
pkg.scripts['db:reset'] = 'npm run db:seed';
fs.writeFileSync('package.json', JSON.stringify(pkg, null, 2));
console.log('✅ Scripts adicionados ao package.json');
"

# =============================================================================
# Executa o seed agora
# =============================================================================
echo ""
...
echo ""
echo "============================================================"
echo "✅ PRONTO! Acesse o sistema com:"
echo "   Email:  admin@demo.com"
echo "   Senha:  Admin@123"
echo ""
echo "   O campo 'X-Tenant-ID' no login deve ser: demo-tenant"
echo "   (o frontend já preenche isso automaticamente)"
echo "============================================================"
